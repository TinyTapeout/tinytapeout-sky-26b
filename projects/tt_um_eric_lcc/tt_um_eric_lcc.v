module tt_um_eric_lcc (clk,
 ...
 sky130_fd_sc_hd__decap_3 FILLER_10_9 (.VGND(VGND),
    ...
    .VPB(VPWR),
    .VPWR(VPWR));
 sky130_fd_sc_hd__decap_3 FILLER_10_95 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR));
 ...
 sky130_fd_sc_hd__decap_3 FILLER_11_12 (.VGND(VGND),
    ...
    .VPB(VPWR),
    .VPWR(VPWR));
 sky130_fd_sc_hd__decap_3 FILLER_11_120 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR));
 ...
 sky130_fd_sc_hd__fill_1 FILLER_11_279 (.VGND(VGND),
    ...
    .VPB(VPWR),
    .VPWR(VPWR));
 sky130_fd_sc_hd__decap_3 FILLER_11_286 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR));
 ...
 sky130_fd_sc_hd__decap_3 FILLER_13_21 (.VGND(VGND),
    ...
    .VPB(VPWR),
    .VPWR(VPWR));
 sky130_fd_sc_hd__decap_3 FILLER_13_210 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR));
 ...
 sky130_fd_sc_hd__decap_3 FILLER_14_9 (.VGND(VGND),
    ...
    .VPB(VPWR),
    .VPWR(VPWR));
 sky130_fd_sc_hd__decap_3 FILLER_14_96 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR));
 ...
 sky130_fd_sc_hd__decap_3 FILLER_15_225 (.VGND(VGND),
    ...
    .VPB(VPWR),
    .VPWR(VPWR));
 sky130_fd_sc_hd__fill_2 FILLER_15_228 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR));
 ...
 sky130_fd_sc_hd__decap_3 FILLER_17_289 (.VGND(VGND),
    ...
    .VPB(VPWR),
    .VPWR(VPWR));
 sky130_fd_sc_hd__decap_3 FILLER_17_292 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR));
 ...
 sky130_fd_sc_hd__fill_1 FILLER_19_314 (.VGND(VGND),
    ...
    .VPB(VPWR),
    .VPWR(VPWR));
 sky130_fd_sc_hd__decap_3 FILLER_19_32 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR));
 ...
 sky130_fd_sc_hd__decap_3 FILLER_19_35 (.VGND(VGND),
    ...
    .VPB(VPWR),
    .VPWR(VPWR));
 sky130_fd_sc_hd__decap_3 FILLER_19_38 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR));
 ...
 sky130_fd_sc_hd__decap_3 FILLER_20_322 (.VGND(VGND),
    ...
    .VPB(VPWR),
    .VPWR(VPWR));
 sky130_fd_sc_hd__decap_3 FILLER_20_325 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR));
 ...
 sky130_fd_sc_hd__decap_3 FILLER_20_40 (.VGND(VGND),
    ...
    .VPB(VPWR),
    .VPWR(VPWR));
 sky130_fd_sc_hd__decap_3 FILLER_20_43 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR));
 ...
 sky130_fd_sc_hd__fill_2 FILLER_21_333 (.VGND(VGND),
    ...
    .VPB(VPWR),
    .VPWR(VPWR));
 sky130_fd_sc_hd__decap_3 FILLER_21_46 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR));
 ...
 sky130_fd_sc_hd__decap_3 FILLER_29_12 (.VGND(VGND),
    ...
    .VPB(VPWR),
    .VPWR(VPWR));
 sky130_fd_sc_hd__decap_3 FILLER_29_126 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR));
 ...
 sky130_fd_sc_hd__decap_3 FILLER_29_300 (.VGND(VGND),
    ...
    .VPB(VPWR),
    .VPWR(VPWR));
 sky130_fd_sc_hd__fill_2 FILLER_29_303 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR));
 ...
 sky130_fd_sc_hd__decap_3 FILLER_34_316 (.VGND(VGND),
    ...
    .VPB(VPWR),
    .VPWR(VPWR));
 sky130_fd_sc_hd__decap_3 FILLER_34_319 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR));
 ...
 sky130_fd_sc_hd__decap_3 FILLER_34_325 (.VGND(VGND),
    ...
    .VPB(VPWR),
    .VPWR(VPWR));
 sky130_fd_sc_hd__decap_3 FILLER_34_328 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR));
 ...
 sky130_fd_sc_hd__tapvpwrvgnd_1 TAP_TAPCELL_ROW_9_137 (.VGND(VGND),
    .VPWR(VPWR));
 sky130_fd_sc_hd__inv_2 _0514_ (.A(net79),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0063_));
 sky130_fd_sc_hd__inv_2 _0515_ (.A(net24),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0064_));
 sky130_fd_sc_hd__inv_2 _0516_ (.A(net26),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0065_));
 sky130_fd_sc_hd__inv_2 _0517_ (.A(\logo_top[7] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0066_));
 sky130_fd_sc_hd__inv_2 _0518_ (.A(\logo_top[6] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0067_));
 sky130_fd_sc_hd__inv_2 _0519_ (.A(\logo_top[4] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0068_));
 sky130_fd_sc_hd__inv_2 _0520_ (.A(\logo_top[3] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0069_));
 sky130_fd_sc_hd__inv_2 _0521_ (.A(\logo_left[8] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0070_));
 sky130_fd_sc_hd__inv_2 _0522_ (.A(\logo_left[7] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0071_));
 sky130_fd_sc_hd__inv_2 _0523_ (.A(\logo_left[6] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0072_));
 sky130_fd_sc_hd__inv_2 _0524_ (.A(\logo_left[3] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0073_));
 sky130_fd_sc_hd__inv_2 _0525_ (.A(\logo_left[2] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0074_));
 sky130_fd_sc_hd__inv_2 _0526_ (.A(\logo_left[0] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0075_));
 sky130_fd_sc_hd__inv_2 _0527_ (.A(net65),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0076_));
 sky130_fd_sc_hd__inv_2 _0528_ (.A(\pix_y[1] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0077_));
 sky130_fd_sc_hd__inv_2 _0529_ (.A(\pix_y[2] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0078_));
 sky130_fd_sc_hd__inv_2 _0530_ (.A(\pix_y[3] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0079_));
 sky130_fd_sc_hd__inv_2 _0531_ (.A(\pix_y[5] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0080_));
 sky130_fd_sc_hd__inv_2 _0532_ (.A(\pix_y[7] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0081_));
 sky130_fd_sc_hd__inv_2 _0533_ (.A(\pix_y[8] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0082_));
 sky130_fd_sc_hd__inv_2 _0534_ (.A(\prev_y[2] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0083_));
 sky130_fd_sc_hd__inv_2 _0535_ (.A(\prev_y[5] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0084_));
 sky130_fd_sc_hd__inv_2 _0536_ (.A(net29),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0085_));
 sky130_fd_sc_hd__inv_2 _0537_ (.A(net3),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0086_));
 sky130_fd_sc_hd__nand4_2 _0538_ (.A(\pix_y[5] ),
    .B(\pix_y[6] ),
    .C(\pix_y[7] ),
    .D(\pix_y[8] ),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0087_));
 sky130_fd_sc_hd__or4_2 _0539_ (.A(_0077_),
    .B(_0079_),
    .C(\pix_y[4] ),
    .D(\pix_y[9] ),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0088_));
 sky130_fd_sc_hd__nor2_2 _0540_ (.A(_0078_),
    .B(_0079_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0089_));
 sky130_fd_sc_hd__or3_2 _0541_ (.A(_0087_),
    .B(_0088_),
    .C(_0089_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0001_));
 sky130_fd_sc_hd__and3_2 _0542_ (.A(\pix_x[4] ),
    .B(\pix_x[5] ),
    .C(\pix_x[6] ),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0090_));
 sky130_fd_sc_hd__o311a_2 _0543_ (.A1(\pix_x[4] ),
    .A2(\pix_x[5] ),
    .A3(\pix_x[6] ),
    .B1(\pix_x[7] ),
    .C1(\pix_x[9] ),
    ...
    .VPWR(VPWR),
    .X(_0091_));
 sky130_fd_sc_hd__or3b_2 _0544_ (.A(net78),
    .B(_0090_),
    .C_N(_0091_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0000_));
 sky130_fd_sc_hd__nand2_2 _0545_ (.A(\pix_x[0] ),
    .B(\pix_x[1] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0092_));
 sky130_fd_sc_hd__nor2_2 _0546_ (.A(_0076_),
    .B(_0092_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0093_));
 sky130_fd_sc_hd__and2_2 _0547_ (.A(\pix_x[3] ),
    .B(_0093_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0094_));
 sky130_fd_sc_hd__and3_2 _0548_ (.A(\pix_x[3] ),
    .B(\pix_x[4] ),
    .C(_0093_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0095_));
 sky130_fd_sc_hd__nor3_2 _0549_ (.A(\pix_x[5] ),
    .B(\pix_x[6] ),
    .C(\pix_x[7] ),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0096_));
 sky130_fd_sc_hd__and4_2 _0550_ (.A(\pix_x[8] ),
    .B(\pix_x[9] ),
    .C(_0095_),
    .D(_0096_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0097_));
 sky130_fd_sc_hd__or2_2 _0551_ (.A(\pix_y[0] ),
    .B(\pix_y[1] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0098_));
 sky130_fd_sc_hd__or2_2 _0552_ (.A(\pix_y[8] ),
    .B(_0098_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0099_));
 sky130_fd_sc_hd__or4_2 _0553_ (.A(\pix_y[4] ),
    .B(\pix_y[5] ),
    .C(\pix_y[6] ),
    .D(\pix_y[7] ),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0100_));
 sky130_fd_sc_hd__nand2_2 _0554_ (.A(\pix_y[9] ),
    .B(_0089_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0101_));
 sky130_fd_sc_hd__o311a_2 _0555_ (.A1(_0099_),
    .A2(_0100_),
    .A3(_0101_),
    .B1(_0097_),
    .C1(net32),
    ...
    .VPWR(VPWR),
    .X(_0102_));
 sky130_fd_sc_hd__nor2_2 _0556_ (.A(_0085_),
    .B(_0097_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0103_));
 sky130_fd_sc_hd__o311a_2 _0557_ (.A1(_0099_),
    .A2(_0100_),
    .A3(_0101_),
    .B1(_0097_),
    .C1(net32),
    ...
    .VPWR(VPWR),
    .X(_0104_));
 sky130_fd_sc_hd__mux2_1 _0558_ (.A0(_0104_),
    .A1(net18),
    .S(\pix_y[0] ),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0002_));
 sky130_fd_sc_hd__nand2_2 _0559_ (.A(\pix_y[0] ),
    .B(\pix_y[1] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0105_));
 sky130_fd_sc_hd__and3_2 _0560_ (.A(_0098_),
    .B(_0102_),
    .C(_0105_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0106_));
 sky130_fd_sc_hd__a21o_2 _0561_ (.A1(\pix_y[1] ),
    .A2(net18),
    .B1(_0106_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0003_));
 sky130_fd_sc_hd__xnor2_2 _0562_ (.A(\pix_y[2] ),
    .B(_0105_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0107_));
 sky130_fd_sc_hd__a22o_2 _0563_ (.A1(\pix_y[2] ),
    .A2(net18),
    .B1(_0107_),
    .B2(_0102_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0004_));
 sky130_fd_sc_hd__a31o_2 _0564_ (.A1(\pix_y[0] ),
    .A2(\pix_y[1] ),
    .A3(\pix_y[2] ),
    .B1(\pix_y[3] ),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0108_));
 sky130_fd_sc_hd__and3_2 _0565_ (.A(\pix_y[0] ),
    .B(\pix_y[1] ),
    .C(_0089_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0109_));
 sky130_fd_sc_hd__and3b_2 _0566_ (.A_N(_0109_),
    .B(_0102_),
    .C(_0108_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0110_));
 sky130_fd_sc_hd__a21o_2 _0567_ (.A1(net71),
    .A2(net18),
    .B1(_0110_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0005_));
 sky130_fd_sc_hd__xor2_2 _0568_ (.A(\pix_y[4] ),
    .B(_0109_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0111_));
 sky130_fd_sc_hd__a22o_2 _0569_ (.A1(\pix_y[4] ),
    .A2(net19),
    .B1(_0111_),
    .B2(_0102_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0006_));
 sky130_fd_sc_hd__a21oi_2 _0570_ (.A1(\pix_y[4] ),
    .A2(_0109_),
    .B1(\pix_y[5] ),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0112_));
 sky130_fd_sc_hd__and3_2 _0571_ (.A(\pix_y[4] ),
    .B(\pix_y[5] ),
    .C(_0109_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0113_));
 sky130_fd_sc_hd__nor2_2 _0572_ (.A(_0112_),
    .B(_0113_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0114_));
 sky130_fd_sc_hd__a22o_2 _0573_ (.A1(\pix_y[5] ),
    .A2(net19),
    .B1(_0114_),
    .B2(_0102_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0007_));
 sky130_fd_sc_hd__or2_2 _0574_ (.A(\pix_y[6] ),
    .B(_0113_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0115_));
 sky130_fd_sc_hd__and2_2 _0575_ (.A(\pix_y[6] ),
    .B(_0113_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0116_));
 sky130_fd_sc_hd__and3b_2 _0576_ (.A_N(_0116_),
    .B(_0102_),
    .C(_0115_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0117_));
 sky130_fd_sc_hd__a21o_2 _0577_ (.A1(\pix_y[6] ),
    .A2(net19),
    .B1(_0117_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0008_));
 sky130_fd_sc_hd__xnor2_2 _0578_ (.A(_0081_),
    .B(_0116_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0118_));
 sky130_fd_sc_hd__a22o_2 _0579_ (.A1(\pix_y[7] ),
    .A2(net19),
    .B1(_0104_),
    .B2(_0118_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0009_));
 sky130_fd_sc_hd__or3b_2 _0580_ (.A(_0081_),
    .B(_0082_),
    .C_N(_0116_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0119_));
 sky130_fd_sc_hd__a21o_2 _0581_ (.A1(_0104_),
    .A2(_0119_),
    .B1(net19),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0120_));
 sky130_fd_sc_hd__a31o_2 _0582_ (.A1(\pix_y[7] ),
    .A2(_0104_),
    .A3(_0116_),
    .B1(\pix_y[8] ),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0121_));
 sky130_fd_sc_hd__and2_2 _0583_ (.A(_0120_),
    .B(_0121_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0010_));
 sky130_fd_sc_hd__or3b_2 _0584_ (.A(_0119_),
    .B(\pix_y[9] ),
    .C_N(_0104_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0122_));
 sky130_fd_sc_hd__a21bo_2 _0585_ (.A1(\pix_y[9] ),
    .A2(_0120_),
    .B1_N(_0122_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0011_));
 sky130_fd_sc_hd__and2b_2 _0586_ (.A_N(net76),
    .B(net19),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0012_));
 sky130_fd_sc_hd__or2_2 _0587_ (.A(\pix_x[0] ),
    .B(\pix_x[1] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0123_));
 sky130_fd_sc_hd__and3_2 _0588_ (.A(_0092_),
    .B(net18),
    .C(_0123_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0013_));
 sky130_fd_sc_hd__a211oi_2 _0589_ (.A1(_0076_),
    .A2(_0092_),
    .B1(_0093_),
    .C1(_0085_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0014_));
 sky130_fd_sc_hd__o21ai_2 _0590_ (.A1(net70),
    .A2(_0093_),
    .B1(net34),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0124_));
 sky130_fd_sc_hd__nor2_2 _0591_ (.A(_0094_),
    .B(_0124_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0015_));
 sky130_fd_sc_hd__o21ai_2 _0592_ (.A1(net73),
    .A2(_0094_),
    .B1(net34),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0125_));
 sky130_fd_sc_hd__nor2_2 _0593_ (.A(_0095_),
    .B(_0125_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0016_));
 sky130_fd_sc_hd__o21ai_2 _0594_ (.A1(\pix_x[5] ),
    .A2(_0095_),
    .B1(net18),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0126_));
 sky130_fd_sc_hd__a21oi_2 _0595_ (.A1(net72),
    .A2(_0095_),
    .B1(_0126_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0017_));
 sky130_fd_sc_hd__a21o_2 _0596_ (.A1(\pix_x[5] ),
    .A2(_0095_),
    .B1(\pix_x[6] ),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0127_));
 sky130_fd_sc_hd__and3_2 _0597_ (.A(\pix_x[5] ),
    .B(\pix_x[6] ),
    .C(_0095_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0128_));
 sky130_fd_sc_hd__and3b_2 _0598_ (.A_N(_0128_),
    .B(net18),
    .C(_0127_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0018_));
 sky130_fd_sc_hd__or2_2 _0599_ (.A(\pix_x[7] ),
    .B(_0128_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0129_));
 sky130_fd_sc_hd__and3_2 _0600_ (.A(\pix_x[7] ),
    .B(_0090_),
    .C(_0094_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0130_));
 sky130_fd_sc_hd__and3b_2 _0601_ (.A_N(_0130_),
    .B(net18),
    .C(_0129_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0019_));
 sky130_fd_sc_hd__and2_2 _0602_ (.A(\pix_x[8] ),
    .B(_0130_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0131_));
 sky130_fd_sc_hd__o21ai_2 _0603_ (.A1(net78),
    .A2(_0130_),
    .B1(net18),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0132_));
 sky130_fd_sc_hd__nor2_2 _0604_ (.A(_0131_),
    .B(_0132_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0020_));
 sky130_fd_sc_hd__o21ai_2 _0605_ (.A1(\pix_x[9] ),
    .A2(_0131_),
    .B1(net18),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0133_));
 sky130_fd_sc_hd__a21oi_2 _0606_ (.A1(net69),
    .A2(_0131_),
    .B1(_0133_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0021_));
 sky130_fd_sc_hd__mux2_1 _0607_ (.A0(net59),
    .A1(\pix_y[0] ),
    .S(net32),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0022_));
 sky130_fd_sc_hd__mux2_1 _0608_ (.A0(net56),
    .A1(\pix_y[1] ),
    .S(net32),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__mux2_1 _0609_ (.A0(net60),
    ...
    .VPWR(VPWR),
    .X(_0024_));
 sky130_fd_sc_hd__mux2_1 _0610_ (.A0(net52),
    .A1(\pix_y[3] ),
    .S(net32),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0025_));
 sky130_fd_sc_hd__mux2_1 _0611_ (.A0(net61),
    .A1(\pix_y[4] ),
    .S(net30),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0026_));
 sky130_fd_sc_hd__mux2_1 _0612_ (.A0(net50),
    .A1(\pix_y[5] ),
    .S(net32),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0027_));
 sky130_fd_sc_hd__mux2_1 _0613_ (.A0(net57),
    .A1(\pix_y[6] ),
    .S(net34),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0028_));
 sky130_fd_sc_hd__mux2_1 _0614_ (.A0(net51),
    .A1(\pix_y[7] ),
    .S(net32),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0029_));
 sky130_fd_sc_hd__mux2_1 _0615_ (.A0(net54),
    .A1(\pix_y[8] ),
    .S(net32),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0030_));
 sky130_fd_sc_hd__mux2_1 _0616_ (.A0(net62),
    .A1(\pix_y[9] ),
    .S(net34),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0031_));
 sky130_fd_sc_hd__xor2_2 _0617_ (.A(\pix_y[9] ),
    .B(\prev_y[9] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0134_));
 sky130_fd_sc_hd__nand2_2 _0618_ (.A(\pix_y[6] ),
    .B(\prev_y[6] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0135_));
 sky130_fd_sc_hd__or2_2 _0619_ (.A(\pix_y[6] ),
    .B(\prev_y[6] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0136_));
 sky130_fd_sc_hd__a22o_2 _0620_ (.A1(_0077_),
    .A2(\prev_y[1] ),
    .B1(\prev_y[3] ),
    .B2(_0079_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0137_));
 sky130_fd_sc_hd__a221o_2 _0621_ (.A1(_0078_),
    .A2(\prev_y[2] ),
    .B1(_0084_),
    .B2(\pix_y[5] ),
    .C1(_0137_),
    ...
    .VPWR(VPWR),
    .X(_0138_));
 sky130_fd_sc_hd__nand2_2 _0622_ (.A(\pix_y[0] ),
    .B(\prev_y[0] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0139_));
 sky130_fd_sc_hd__or2_2 _0623_ (.A(\pix_y[0] ),
    .B(\prev_y[0] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0140_));
 sky130_fd_sc_hd__a22o_2 _0624_ (.A1(_0081_),
    .A2(\prev_y[7] ),
    .B1(\prev_y[8] ),
    .B2(_0082_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0141_));
 sky130_fd_sc_hd__a221o_2 _0625_ (.A1(\pix_y[2] ),
    .A2(_0083_),
    .B1(_0139_),
    .B2(_0140_),
    .C1(_0141_),
    ...
    .VPWR(VPWR),
    .X(_0142_));
 sky130_fd_sc_hd__xnor2_2 _0626_ (.A(\pix_y[4] ),
    .B(\prev_y[4] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0143_));
 sky130_fd_sc_hd__o221a_2 _0627_ (.A1(\pix_y[5] ),
    .A2(_0084_),
    .B1(\prev_y[7] ),
    .B2(_0081_),
    .C1(_0143_),
    ...
    .VPWR(VPWR),
    .X(_0144_));
 sky130_fd_sc_hd__a21oi_2 _0628_ (.A1(_0135_),
    .A2(_0136_),
    .B1(_0134_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0145_));
 sky130_fd_sc_hd__o22a_2 _0629_ (.A1(_0077_),
    .A2(\prev_y[1] ),
    .B1(\prev_y[3] ),
    .B2(_0079_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0146_));
 sky130_fd_sc_hd__o2111a_2 _0630_ (.A1(_0082_),
    .A2(\prev_y[8] ),
    .B1(_0144_),
    .C1(_0145_),
    .D1(_0146_),
    ...
    .VPWR(VPWR),
    .X(_0147_));
 sky130_fd_sc_hd__or3b_2 _0631_ (.A(_0138_),
    .B(_0142_),
    .C_N(_0147_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0148_));
 sky130_fd_sc_hd__and4bb_2 _0632_ (.A_N(_0099_),
    .B_N(\pix_y[9] ),
    .C(_0079_),
    .D(_0078_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0149_));
 sky130_fd_sc_hd__and3b_2 _0633_ (.A_N(_0100_),
    .B(_0148_),
    .C(_0149_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0150_));
 sky130_fd_sc_hd__inv_2 _0634_ (.A(net16),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0151_));
 sky130_fd_sc_hd__and3b_2 _0635_ (.A_N(_0100_),
    .B(_0148_),
    .C(_0149_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0152_));
 sky130_fd_sc_hd__o21ai_2 _0636_ (.A1(net63),
    .A2(net15),
    .B1(net28),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0153_));
 sky130_fd_sc_hd__a21oi_2 _0637_ (.A1(net63),
    .A2(net16),
    .B1(_0153_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0032_));
 sky130_fd_sc_hd__xor2_2 _0638_ (.A(net25),
    .B(\logo_left[1] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0154_));
 sky130_fd_sc_hd__nor2_2 _0639_ (.A(_0075_),
    .B(_0154_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0155_));
 sky130_fd_sc_hd__nand2_2 _0640_ (.A(_0075_),
    .B(_0154_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0156_));
 sky130_fd_sc_hd__and2b_2 _0641_ (.A_N(_0155_),
    .B(_0156_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0157_));
 sky130_fd_sc_hd__o221a_2 _0642_ (.A1(\logo_left[1] ),
    .A2(net15),
    .B1(_0157_),
    .B2(_0151_),
    .C1(net28),
    ...
    .VPWR(VPWR),
    .X(_0033_));
 sky130_fd_sc_hd__xor2_2 _0643_ (.A(net26),
    .B(\logo_left[2] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0158_));
 sky130_fd_sc_hd__a21oi_2 _0644_ (.A1(net23),
    .A2(\logo_left[1] ),
    .B1(_0155_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0159_));
 sky130_fd_sc_hd__nor2_2 _0645_ (.A(_0158_),
    .B(_0159_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0160_));
 sky130_fd_sc_hd__xnor2_2 _0646_ (.A(_0158_),
    .B(_0159_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0161_));
 sky130_fd_sc_hd__nand2_2 _0647_ (.A(net16),
    .B(_0161_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0162_));
 sky130_fd_sc_hd__o211a_2 _0648_ (.A1(\logo_left[2] ),
    .A2(net15),
    .B1(_0162_),
    .C1(net28),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0034_));
 sky130_fd_sc_hd__o21ai_2 _0649_ (.A1(_0073_),
    .A2(net16),
    .B1(net29),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0163_));
 sky130_fd_sc_hd__a21oi_2 _0650_ (.A1(net23),
    .A2(\logo_left[2] ),
    .B1(_0160_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0164_));
 sky130_fd_sc_hd__xnor2_2 _0651_ (.A(net26),
    .B(\logo_left[3] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0165_));
 sky130_fd_sc_hd__xnor2_2 _0652_ (.A(_0164_),
    .B(_0165_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0166_));
 sky130_fd_sc_hd__a21o_2 _0653_ (.A1(net16),
    .A2(_0166_),
    .B1(_0163_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0035_));
 sky130_fd_sc_hd__nand2_2 _0654_ (.A(net23),
    .B(\logo_left[4] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0167_));
 sky130_fd_sc_hd__or2_2 _0655_ (.A(net23),
    .B(\logo_left[4] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0168_));
 sky130_fd_sc_hd__nand2_2 _0656_ (.A(_0167_),
    .B(_0168_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0169_));
 sky130_fd_sc_hd__a21oi_2 _0657_ (.A1(net26),
    .A2(_0073_),
    .B1(_0164_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0170_));
 sky130_fd_sc_hd__a21oi_2 _0658_ (.A1(net23),
    .A2(\logo_left[3] ),
    .B1(_0170_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0171_));
 sky130_fd_sc_hd__or2_2 _0659_ (.A(_0169_),
    .B(_0171_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0172_));
 sky130_fd_sc_hd__nand2_2 _0660_ (.A(_0169_),
    .B(_0171_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0173_));
 sky130_fd_sc_hd__a21o_2 _0661_ (.A1(_0172_),
    .A2(_0173_),
    .B1(_0151_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0174_));
 sky130_fd_sc_hd__o211a_2 _0662_ (.A1(\logo_left[4] ),
    .A2(net15),
    .B1(_0174_),
    .C1(net29),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0036_));
 sky130_fd_sc_hd__xnor2_2 _0663_ (.A(net26),
    .B(\logo_left[5] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0175_));
 sky130_fd_sc_hd__a21oi_2 _0664_ (.A1(_0167_),
    .A2(_0172_),
    .B1(_0175_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0176_));
 sky130_fd_sc_hd__a311o_2 _0665_ (.A1(_0167_),
    .A2(_0172_),
    .A3(_0175_),
    .B1(_0176_),
    .C1(_0151_),
    ...
    .VPWR(VPWR),
    .X(_0177_));
 sky130_fd_sc_hd__o211a_2 _0666_ (.A1(\logo_left[5] ),
    .A2(net15),
    .B1(_0177_),
    .C1(net29),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0037_));
 sky130_fd_sc_hd__xnor2_2 _0667_ (.A(net27),
    .B(\logo_left[6] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0178_));
 sky130_fd_sc_hd__and2b_2 _0668_ (.A_N(_0172_),
    .B(_0175_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0179_));
 sky130_fd_sc_hd__o21a_2 _0669_ (.A1(\logo_left[5] ),
    .A2(\logo_left[4] ),
    .B1(net23),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0180_));
 sky130_fd_sc_hd__o21a_2 _0670_ (.A1(_0179_),
    .A2(_0180_),
    .B1(_0178_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0181_));
 sky130_fd_sc_hd__inv_2 _0671_ (.A(_0181_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0182_));
 sky130_fd_sc_hd__o31a_2 _0672_ (.A1(_0178_),
    .A2(_0179_),
    .A3(_0180_),
    .B1(net15),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0183_));
 sky130_fd_sc_hd__a221o_2 _0673_ (.A1(\logo_left[6] ),
    .A2(_0151_),
    .B1(_0182_),
    .B2(_0183_),
    .C1(_0085_),
    ...
    .VPWR(VPWR),
    .X(_0038_));
 sky130_fd_sc_hd__o21ai_2 _0674_ (.A1(_0071_),
    .A2(net16),
    .B1(net29),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0184_));
 sky130_fd_sc_hd__xnor2_2 _0675_ (.A(net27),
    .B(\logo_left[7] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0185_));
 sky130_fd_sc_hd__a21oi_2 _0676_ (.A1(net23),
    .A2(\logo_left[6] ),
    .B1(_0181_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0186_));
 sky130_fd_sc_hd__xnor2_2 _0677_ (.A(_0185_),
    .B(_0186_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0187_));
 sky130_fd_sc_hd__a21o_2 _0678_ (.A1(net16),
    .A2(_0187_),
    .B1(_0184_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0039_));
 sky130_fd_sc_hd__o41a_2 _0679_ (.A1(\logo_left[7] ),
    .A2(\logo_left[6] ),
    .A3(\logo_left[5] ),
    .A4(\logo_left[4] ),
    .B1(net23),
    ...
    .VPWR(VPWR),
    .X(_0188_));
 sky130_fd_sc_hd__a31o_2 _0680_ (.A1(_0178_),
    .A2(_0179_),
    .A3(_0185_),
    .B1(_0188_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0189_));
 sky130_fd_sc_hd__or2_2 _0681_ (.A(\logo_left[8] ),
    .B(net16),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0190_));
 sky130_fd_sc_hd__xor2_2 _0682_ (.A(net27),
    .B(\logo_left[8] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0191_));
 sky130_fd_sc_hd__xnor2_2 _0683_ (.A(_0189_),
    .B(_0191_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0192_));
 sky130_fd_sc_hd__o211a_2 _0684_ (.A1(_0151_),
    .A2(_0192_),
    .B1(_0190_),
    .C1(net29),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0040_));
 sky130_fd_sc_hd__mux2_1 _0685_ (.A0(net23),
    .A1(\logo_left[8] ),
    .S(_0189_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0193_));
 sky130_fd_sc_hd__o211a_2 _0686_ (.A1(net25),
    .A2(_0070_),
    .B1(net15),
    .C1(_0193_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0194_));
 sky130_fd_sc_hd__xnor2_2 _0687_ (.A(net77),
    .B(_0194_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0195_));
 sky130_fd_sc_hd__nor2_2 _0688_ (.A(_0085_),
    .B(_0195_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0041_));
 sky130_fd_sc_hd__or2_2 _0689_ (.A(\logo_top[0] ),
    .B(net16),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0196_));
 sky130_fd_sc_hd__nand2_2 _0690_ (.A(\logo_top[0] ),
    .B(net16),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0197_));
 sky130_fd_sc_hd__and3_2 _0691_ (.A(net30),
    .B(_0196_),
    .C(_0197_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0042_));
 sky130_fd_sc_hd__and2_2 _0692_ (.A(_0064_),
    .B(\logo_top[1] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0198_));
 sky130_fd_sc_hd__nor2_2 _0693_ (.A(_0064_),
    .B(\logo_top[1] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0199_));
 sky130_fd_sc_hd__nor2_2 _0694_ (.A(_0198_),
    .B(_0199_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0200_));
 sky130_fd_sc_hd__xor2_2 _0695_ (.A(\logo_top[0] ),
    .B(_0200_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0201_));
 sky130_fd_sc_hd__o221a_2 _0696_ (.A1(\logo_top[1] ),
    .A2(net15),
    .B1(_0201_),
    .B2(_0151_),
    .C1(net30),
    ...
    .VPWR(VPWR),
    .X(_0043_));
 sky130_fd_sc_hd__or2_2 _0697_ (.A(\logo_top[2] ),
    .B(net17),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0202_));
 sky130_fd_sc_hd__nor2_2 _0698_ (.A(_0064_),
    .B(\logo_top[2] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0203_));
 sky130_fd_sc_hd__and2_2 _0699_ (.A(_0064_),
    .B(\logo_top[2] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0204_));
 sky130_fd_sc_hd__or2_2 _0700_ (.A(_0203_),
    .B(_0204_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0205_));
 sky130_fd_sc_hd__a21oi_2 _0701_ (.A1(\logo_top[0] ),
    .A2(_0200_),
    .B1(_0198_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0206_));
 sky130_fd_sc_hd__xor2_2 _0702_ (.A(_0205_),
    .B(_0206_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0207_));
 sky130_fd_sc_hd__o211a_2 _0703_ (.A1(_0151_),
    .A2(_0207_),
    .B1(_0202_),
    .C1(net30),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0044_));
 sky130_fd_sc_hd__nor2_2 _0704_ (.A(\logo_top[2] ),
    .B(_0206_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0208_));
 sky130_fd_sc_hd__a2111o_2 _0705_ (.A1(net24),
    .A2(_0206_),
    .B1(_0208_),
    .C1(_0151_),
    .D1(_0204_),
    ...
    .VPWR(VPWR),
    .X(_0209_));
 sky130_fd_sc_hd__o21a_2 _0706_ (.A1(\logo_top[3] ),
    .A2(_0209_),
    .B1(net30),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0210_));
 sky130_fd_sc_hd__a21bo_2 _0707_ (.A1(net75),
    .A2(_0209_),
    .B1_N(_0210_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0045_));
 sky130_fd_sc_hd__xnor2_2 _0708_ (.A(net24),
    .B(\logo_top[4] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0211_));
 sky130_fd_sc_hd__nor2_2 _0709_ (.A(\logo_top[3] ),
    .B(\logo_top[2] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0212_));
 sky130_fd_sc_hd__o22a_2 _0710_ (.A1(_0205_),
    .A2(_0206_),
    .B1(_0212_),
    .B2(net24),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0213_));
 sky130_fd_sc_hd__a21oi_2 _0711_ (.A1(net24),
    .A2(_0069_),
    .B1(_0213_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0214_));
 sky130_fd_sc_hd__nand2_2 _0712_ (.A(_0211_),
    .B(_0214_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0215_));
 sky130_fd_sc_hd__or2_2 _0713_ (.A(_0211_),
    .B(_0214_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0216_));
 sky130_fd_sc_hd__a21o_2 _0714_ (.A1(_0215_),
    .A2(_0216_),
    .B1(_0151_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0217_));
 sky130_fd_sc_hd__o211a_2 _0715_ (.A1(\logo_top[4] ),
    .A2(net15),
    .B1(_0217_),
    .C1(net30),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0046_));
 sky130_fd_sc_hd__xor2_2 _0716_ (.A(net24),
    .B(\logo_top[5] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0218_));
 sky130_fd_sc_hd__o21ai_2 _0717_ (.A1(net24),
    .A2(_0068_),
    .B1(_0215_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0219_));
 sky130_fd_sc_hd__o21ai_2 _0718_ (.A1(_0218_),
    .A2(_0219_),
    .B1(net17),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0220_));
 sky130_fd_sc_hd__a21o_2 _0719_ (.A1(_0218_),
    .A2(_0219_),
    .B1(_0220_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0221_));
 sky130_fd_sc_hd__o211a_2 _0720_ (.A1(\logo_top[5] ),
    .A2(_0152_),
    .B1(_0221_),
    .C1(net30),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0047_));
 sky130_fd_sc_hd__xnor2_2 _0721_ (.A(net24),
    .B(\logo_top[6] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0222_));
 sky130_fd_sc_hd__nor2_2 _0722_ (.A(_0215_),
    .B(_0218_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0223_));
 sky130_fd_sc_hd__o21a_2 _0723_ (.A1(\logo_top[5] ),
    .A2(\logo_top[4] ),
    .B1(_0064_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0224_));
 sky130_fd_sc_hd__or2_2 _0724_ (.A(_0223_),
    .B(_0224_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0225_));
 sky130_fd_sc_hd__or2_2 _0725_ (.A(_0222_),
    .B(_0225_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0226_));
 sky130_fd_sc_hd__nand2_2 _0726_ (.A(_0222_),
    .B(_0225_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0227_));
 sky130_fd_sc_hd__o21ai_2 _0727_ (.A1(_0067_),
    .A2(_0152_),
    .B1(net30),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0228_));
 sky130_fd_sc_hd__a31o_2 _0728_ (.A1(net17),
    .A2(_0226_),
    .A3(_0227_),
    .B1(_0228_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0048_));
 sky130_fd_sc_hd__o21ai_2 _0729_ (.A1(_0066_),
    .A2(net17),
    .B1(net30),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0229_));
 sky130_fd_sc_hd__xor2_2 _0730_ (.A(net24),
    .B(\logo_top[7] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0230_));
 sky130_fd_sc_hd__inv_2 _0731_ (.A(_0230_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0231_));
 sky130_fd_sc_hd__o21a_2 _0732_ (.A1(net24),
    .A2(_0067_),
    .B1(_0227_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0232_));
 sky130_fd_sc_hd__xnor2_2 _0733_ (.A(_0231_),
    .B(_0232_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0233_));
 sky130_fd_sc_hd__a21o_2 _0734_ (.A1(net17),
    .A2(_0233_),
    .B1(_0229_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0049_));
 sky130_fd_sc_hd__o41a_2 _0735_ (.A1(\logo_top[7] ),
    .A2(\logo_top[6] ),
    .A3(\logo_top[5] ),
    .A4(\logo_top[4] ),
    .B1(_0064_),
    ...
    .VPWR(VPWR),
    .X(_0234_));
 sky130_fd_sc_hd__a31o_2 _0736_ (.A1(_0222_),
    .A2(_0223_),
    .A3(_0231_),
    .B1(_0234_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0235_));
 sky130_fd_sc_hd__nor2_2 _0737_ (.A(dir_y),
    .B(\logo_top[8] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0236_));
 sky130_fd_sc_hd__and2_2 _0738_ (.A(dir_y),
    .B(\logo_top[8] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0237_));
 sky130_fd_sc_hd__nor2_2 _0739_ (.A(_0236_),
    .B(_0237_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0238_));
 sky130_fd_sc_hd__xnor2_2 _0740_ (.A(_0235_),
    .B(_0238_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0239_));
 sky130_fd_sc_hd__or2_2 _0741_ (.A(\logo_top[8] ),
    .B(net17),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0240_));
 sky130_fd_sc_hd__o211a_2 _0742_ (.A1(_0151_),
    .A2(_0239_),
    .B1(_0240_),
    .C1(net30),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0050_));
 sky130_fd_sc_hd__mux2_1 _0743_ (.A0(_0236_),
    .A1(_0237_),
    .S(_0235_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0241_));
 sky130_fd_sc_hd__a21o_2 _0744_ (.A1(_0152_),
    .A2(_0241_),
    .B1(\logo_top[9] ),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0242_));
 sky130_fd_sc_hd__nand3_2 _0745_ (.A(\logo_top[9] ),
    .B(_0152_),
    .C(_0241_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0243_));
 sky130_fd_sc_hd__and3_2 _0746_ (.A(net31),
    .B(_0242_),
    .C(_0243_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0051_));
 sky130_fd_sc_hd__or4_2 _0747_ (.A(\logo_left[8] ),
    .B(\logo_left[7] ),
    .C(\logo_left[6] ),
    .D(\logo_left[5] ),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0244_));
 sky130_fd_sc_hd__or3_2 _0748_ (.A(\logo_left[3] ),
    .B(\logo_left[2] ),
    .C(\logo_left[1] ),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0245_));
 sky130_fd_sc_hd__and3_2 _0749_ (.A(\logo_left[4] ),
    .B(\logo_left[3] ),
    .C(\logo_left[2] ),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0246_));
 sky130_fd_sc_hd__and4_2 _0750_ (.A(\logo_left[8] ),
    .B(\logo_left[7] ),
    .C(\logo_left[6] ),
    .D(\logo_left[5] ),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0247_));
 sky130_fd_sc_hd__a31o_2 _0751_ (.A1(\logo_left[1] ),
    .A2(_0246_),
    .A3(_0247_),
    .B1(net23),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0248_));
 sky130_fd_sc_hd__o31a_2 _0752_ (.A1(\logo_left[4] ),
    .A2(_0244_),
    .A3(_0245_),
    .B1(_0065_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0249_));
 sky130_fd_sc_hd__nor2_2 _0753_ (.A(\logo_left[9] ),
    .B(_0249_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0250_));
 sky130_fd_sc_hd__and4_2 _0754_ (.A(\logo_left[0] ),
    .B(net15),
    .C(_0248_),
    .D(_0250_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0251_));
 sky130_fd_sc_hd__xnor2_2 _0755_ (.A(net64),
    .B(_0251_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0252_));
 sky130_fd_sc_hd__nand2_2 _0756_ (.A(net29),
    .B(_0252_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0052_));
 sky130_fd_sc_hd__or3_2 _0757_ (.A(\logo_top[9] ),
    .B(\logo_top[7] ),
    .C(\logo_top[5] ),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0253_));
 sky130_fd_sc_hd__and4_2 _0758_ (.A(\logo_top[6] ),
    .B(\logo_top[4] ),
    .C(\logo_top[3] ),
    .D(\logo_top[2] ),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0254_));
 sky130_fd_sc_hd__a21bo_2 _0759_ (.A1(_0237_),
    .A2(_0254_),
    .B1_N(\logo_top[1] ),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0255_));
 sky130_fd_sc_hd__a41o_2 _0760_ (.A1(_0067_),
    .A2(_0068_),
    .A3(_0212_),
    .A4(_0236_),
    .B1(\logo_top[1] ),
    ...
    .VPWR(VPWR),
    .X(_0256_));
 sky130_fd_sc_hd__and4bb_2 _0761_ (.A_N(_0197_),
    .B_N(_0253_),
    .C(_0255_),
    .D(_0256_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0257_));
 sky130_fd_sc_hd__o21ai_2 _0762_ (.A1(net58),
    .A2(_0257_),
    .B1(net31),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0258_));
 sky130_fd_sc_hd__a21oi_2 _0763_ (.A1(net58),
    .A2(_0257_),
    .B1(_0258_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0053_));
 sky130_fd_sc_hd__or3_2 _0764_ (.A(\color_index[0] ),
    .B(_0251_),
    .C(_0257_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0259_));
 sky130_fd_sc_hd__o21a_2 _0765_ (.A1(_0251_),
    .A2(_0257_),
    .B1(\color_index[0] ),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0260_));
 sky130_fd_sc_hd__and3b_2 _0766_ (.A_N(_0260_),
    .B(net31),
    .C(_0259_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0054_));
 sky130_fd_sc_hd__and2_2 _0767_ (.A(\color_index[1] ),
    .B(_0260_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0261_));
 sky130_fd_sc_hd__o21ai_2 _0768_ (.A1(net74),
    .A2(_0260_),
    .B1(net31),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0262_));
 sky130_fd_sc_hd__nor2_2 _0769_ (.A(_0261_),
    .B(_0262_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0055_));
 sky130_fd_sc_hd__o21ai_2 _0770_ (.A1(\color_index[2] ),
    .A2(_0261_),
    .B1(net31),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0263_));
 sky130_fd_sc_hd__a21oi_2 _0771_ (.A1(net67),
    .A2(_0261_),
    .B1(_0263_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0056_));
 sky130_fd_sc_hd__and2b_2 _0772_ (.A_N(\logo_left[1] ),
    .B(\pix_x[1] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0264_));
 sky130_fd_sc_hd__xnor2_2 _0773_ (.A(\logo_left[1] ),
    .B(\pix_x[1] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0265_));
 sky130_fd_sc_hd__nand2b_2 _0774_ (.A_N(\pix_x[0] ),
    .B(\logo_left[0] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0266_));
 sky130_fd_sc_hd__xor2_2 _0775_ (.A(_0265_),
    .B(_0266_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0267_));
 sky130_fd_sc_hd__xnor2_2 _0776_ (.A(_0265_),
    .B(_0266_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0268_));
 sky130_fd_sc_hd__and2_2 _0777_ (.A(_0067_),
    .B(\pix_y[6] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0269_));
 sky130_fd_sc_hd__or2_2 _0778_ (.A(_0067_),
    .B(\pix_y[6] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0270_));
 sky130_fd_sc_hd__nand2b_2 _0779_ (.A_N(_0269_),
    .B(_0270_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0271_));
 sky130_fd_sc_hd__and2_2 _0780_ (.A(_0068_),
    .B(\pix_y[4] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0272_));
 sky130_fd_sc_hd__nor2_2 _0781_ (.A(\logo_top[3] ),
    .B(_0079_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0273_));
 sky130_fd_sc_hd__nor2_2 _0782_ (.A(_0069_),
    .B(\pix_y[3] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0274_));
 sky130_fd_sc_hd__nor2_2 _0783_ (.A(_0273_),
    .B(_0274_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0275_));
 sky130_fd_sc_hd__and2b_2 _0784_ (.A_N(\logo_top[2] ),
    .B(\pix_y[2] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0276_));
 sky130_fd_sc_hd__and2b_2 _0785_ (.A_N(\logo_top[1] ),
    .B(\pix_y[1] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0277_));
 sky130_fd_sc_hd__nand2b_2 _0786_ (.A_N(\pix_y[0] ),
    .B(\logo_top[0] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0278_));
 sky130_fd_sc_hd__xnor2_2 _0787_ (.A(\logo_top[1] ),
    .B(\pix_y[1] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0279_));
 sky130_fd_sc_hd__a21o_2 _0788_ (.A1(_0278_),
    .A2(_0279_),
    .B1(_0277_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0280_));
 sky130_fd_sc_hd__and2b_2 _0789_ (.A_N(\pix_y[2] ),
    .B(\logo_top[2] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0281_));
 sky130_fd_sc_hd__nor2_2 _0790_ (.A(_0276_),
    .B(_0281_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0282_));
 sky130_fd_sc_hd__a21oi_2 _0791_ (.A1(_0280_),
    .A2(_0282_),
    .B1(_0276_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0283_));
 sky130_fd_sc_hd__o21bai_2 _0792_ (.A1(_0274_),
    .A2(_0283_),
    .B1_N(_0273_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0284_));
 sky130_fd_sc_hd__nor2_2 _0793_ (.A(_0068_),
    .B(\pix_y[4] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0285_));
 sky130_fd_sc_hd__nor2_2 _0794_ (.A(_0272_),
    .B(_0285_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0286_));
 sky130_fd_sc_hd__a21o_2 _0795_ (.A1(_0284_),
    .A2(_0286_),
    .B1(_0272_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0287_));
 sky130_fd_sc_hd__o21ba_2 _0796_ (.A1(\logo_top[5] ),
    .A2(_0080_),
    .B1_N(_0287_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0288_));
 sky130_fd_sc_hd__a21oi_2 _0797_ (.A1(\logo_top[5] ),
    .A2(_0080_),
    .B1(_0288_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0289_));
 sky130_fd_sc_hd__xnor2_2 _0798_ (.A(_0271_),
    .B(_0289_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0290_));
 sky130_fd_sc_hd__xnor2_2 _0799_ (.A(_0275_),
    .B(_0283_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0291_));
 sky130_fd_sc_hd__inv_2 _0800_ (.A(_0291_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0292_));
 sky130_fd_sc_hd__xnor2_2 _0801_ (.A(\logo_left[6] ),
    .B(\pix_x[6] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0293_));
 sky130_fd_sc_hd__and2b_2 _0802_ (.A_N(\pix_x[5] ),
    .B(\logo_left[5] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0294_));
 sky130_fd_sc_hd__nand2b_2 _0803_ (.A_N(\pix_x[5] ),
    .B(\logo_left[5] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0295_));
 sky130_fd_sc_hd__and2b_2 _0804_ (.A_N(\logo_left[5] ),
    .B(\pix_x[5] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0296_));
 sky130_fd_sc_hd__and2b_2 _0805_ (.A_N(\logo_left[4] ),
    .B(\pix_x[4] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0297_));
 sky130_fd_sc_hd__and2b_2 _0806_ (.A_N(\pix_x[4] ),
    .B(\logo_left[4] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0298_));
 sky130_fd_sc_hd__nor2_2 _0807_ (.A(_0297_),
    .B(_0298_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0299_));
 sky130_fd_sc_hd__and2b_2 _0808_ (.A_N(\pix_x[3] ),
    .B(\logo_left[3] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0300_));
 sky130_fd_sc_hd__nand2b_2 _0809_ (.A_N(\pix_x[3] ),
    .B(\logo_left[3] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0301_));
 sky130_fd_sc_hd__and2b_2 _0810_ (.A_N(\logo_left[2] ),
    .B(\pix_x[2] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0302_));
 sky130_fd_sc_hd__and2b_2 _0811_ (.A_N(\pix_x[2] ),
    .B(\logo_left[2] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0303_));
 sky130_fd_sc_hd__nor2_2 _0812_ (.A(_0302_),
    .B(_0303_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0304_));
 sky130_fd_sc_hd__a21o_2 _0813_ (.A1(_0265_),
    .A2(_0266_),
    .B1(_0264_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0305_));
 sky130_fd_sc_hd__and2b_2 _0814_ (.A_N(\logo_left[3] ),
    .B(\pix_x[3] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0306_));
 sky130_fd_sc_hd__a31o_2 _0815_ (.A1(_0074_),
    .A2(\pix_x[2] ),
    .A3(_0301_),
    .B1(_0306_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0307_));
 sky130_fd_sc_hd__nor2_2 _0816_ (.A(_0300_),
    .B(_0306_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0308_));
 sky130_fd_sc_hd__a31o_2 _0817_ (.A1(_0304_),
    .A2(_0305_),
    .A3(_0308_),
    .B1(_0307_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0309_));
 sky130_fd_sc_hd__a21o_2 _0818_ (.A1(_0299_),
    .A2(_0309_),
    .B1(_0297_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0310_));
 sky130_fd_sc_hd__a211o_2 _0819_ (.A1(_0299_),
    .A2(_0309_),
    .B1(_0296_),
    .C1(_0297_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0311_));
 sky130_fd_sc_hd__and3_2 _0820_ (.A(_0293_),
    .B(_0295_),
    .C(_0311_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0312_));
 sky130_fd_sc_hd__nand3_2 _0821_ (.A(_0293_),
    .B(_0295_),
    .C(_0311_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0313_));
 sky130_fd_sc_hd__a21oi_2 _0822_ (.A1(_0295_),
    .A2(_0311_),
    .B1(_0293_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0314_));
 sky130_fd_sc_hd__a21o_2 _0823_ (.A1(_0295_),
    .A2(_0311_),
    .B1(_0293_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0315_));
 sky130_fd_sc_hd__nor2_2 _0824_ (.A(_0312_),
    .B(_0314_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0316_));
 sky130_fd_sc_hd__nand2_2 _0825_ (.A(_0313_),
    .B(_0315_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0317_));
 sky130_fd_sc_hd__xor2_2 _0826_ (.A(_0299_),
    .B(_0309_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0318_));
 sky130_fd_sc_hd__xnor2_4 _0827_ (.A(_0299_),
    .B(_0309_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0319_));
 sky130_fd_sc_hd__a21o_2 _0828_ (.A1(_0304_),
    .A2(_0305_),
    .B1(_0302_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0320_));
 sky130_fd_sc_hd__xnor2_2 _0829_ (.A(_0308_),
    .B(_0320_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0321_));
 sky130_fd_sc_hd__nor2_2 _0830_ (.A(_0318_),
    .B(net20),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0322_));
 sky130_fd_sc_hd__nor2_2 _0831_ (.A(_0294_),
    .B(_0296_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0323_));
 sky130_fd_sc_hd__xor2_2 _0832_ (.A(_0310_),
    .B(_0323_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0324_));
 sky130_fd_sc_hd__xnor2_2 _0833_ (.A(_0310_),
    .B(_0323_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0325_));
 sky130_fd_sc_hd__or2_2 _0834_ (.A(net20),
    .B(net14),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0326_));
 sky130_fd_sc_hd__nor2_2 _0835_ (.A(net10),
    .B(_0326_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0327_));
 sky130_fd_sc_hd__o211a_2 _0836_ (.A1(_0312_),
    .A2(_0314_),
    .B1(_0322_),
    .C1(net13),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0328_));
 sky130_fd_sc_hd__nor2_2 _0837_ (.A(net21),
    .B(_0328_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0329_));
 sky130_fd_sc_hd__xnor2_2 _0838_ (.A(\logo_top[5] ),
    .B(\pix_y[5] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0330_));
 sky130_fd_sc_hd__xnor2_2 _0839_ (.A(_0287_),
    .B(_0330_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0331_));
 sky130_fd_sc_hd__inv_2 _0840_ (.A(net7),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0332_));
 sky130_fd_sc_hd__xnor2_2 _0841_ (.A(_0284_),
    .B(_0286_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0333_));
 sky130_fd_sc_hd__nand2_2 _0842_ (.A(_0292_),
    .B(net11),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0334_));
 sky130_fd_sc_hd__xor2_2 _0843_ (.A(_0280_),
    .B(_0282_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0335_));
 sky130_fd_sc_hd__xnor2_2 _0844_ (.A(_0280_),
    .B(_0282_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0336_));
 sky130_fd_sc_hd__xnor2_2 _0845_ (.A(_0278_),
    .B(_0279_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0337_));
 sky130_fd_sc_hd__nor2_2 _0846_ (.A(net22),
    .B(_0337_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0338_));
 sky130_fd_sc_hd__or2_2 _0847_ (.A(net22),
    .B(_0337_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0339_));
 sky130_fd_sc_hd__and2_2 _0848_ (.A(_0319_),
    .B(net20),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0340_));
 sky130_fd_sc_hd__nand2_2 _0849_ (.A(_0319_),
    .B(net20),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0341_));
 sky130_fd_sc_hd__and2_2 _0850_ (.A(net20),
    .B(net13),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0342_));
 sky130_fd_sc_hd__nor2_2 _0851_ (.A(net14),
    .B(_0341_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0343_));
 sky130_fd_sc_hd__a211o_2 _0852_ (.A1(_0313_),
    .A2(_0315_),
    .B1(net14),
    .C1(_0341_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0344_));
 sky130_fd_sc_hd__nor2_2 _0853_ (.A(net20),
    .B(net13),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0345_));
 sky130_fd_sc_hd__nor2_2 _0854_ (.A(_0319_),
    .B(net20),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0346_));
 sky130_fd_sc_hd__or2_2 _0855_ (.A(_0319_),
    .B(net20),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0347_));
 sky130_fd_sc_hd__nor2_2 _0856_ (.A(net13),
    .B(_0347_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0348_));
 sky130_fd_sc_hd__nor2_2 _0857_ (.A(net8),
    .B(_0319_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0349_));
 sky130_fd_sc_hd__o41a_2 _0858_ (.A1(_0312_),
    .A2(_0314_),
    .A3(net13),
    .A4(_0347_),
    .B1(net11),
    ...
    .VPWR(VPWR),
    .X(_0350_));
 sky130_fd_sc_hd__nand3_2 _0859_ (.A(_0339_),
    .B(_0344_),
    .C(_0350_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0351_));
 sky130_fd_sc_hd__a21o_2 _0860_ (.A1(_0334_),
    .A2(_0351_),
    .B1(net7),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0352_));
 sky130_fd_sc_hd__a22o_2 _0861_ (.A1(_0313_),
    .A2(_0315_),
    .B1(_0322_),
    .B2(net13),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0353_));
 sky130_fd_sc_hd__nor2_2 _0862_ (.A(net14),
    .B(_0347_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0354_));
 sky130_fd_sc_hd__a211o_2 _0863_ (.A1(net13),
    .A2(_0346_),
    .B1(_0312_),
    .C1(_0314_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0355_));
 sky130_fd_sc_hd__a2111o_2 _0864_ (.A1(net13),
    .A2(_0346_),
    .B1(_0340_),
    .C1(_0312_),
    .D1(_0314_),
    ...
    .VPWR(VPWR),
    .X(_0356_));
 sky130_fd_sc_hd__nand2_2 _0865_ (.A(net6),
    .B(_0356_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0357_));
 sky130_fd_sc_hd__or2_2 _0866_ (.A(net21),
    .B(_0335_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0358_));
 sky130_fd_sc_hd__inv_2 _0867_ (.A(_0358_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0359_));
 sky130_fd_sc_hd__and2_2 _0868_ (.A(net22),
    .B(_0337_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0360_));
 sky130_fd_sc_hd__nand2_2 _0869_ (.A(net22),
    .B(_0337_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0361_));
 sky130_fd_sc_hd__nand2_2 _0870_ (.A(net21),
    .B(_0361_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0362_));
 sky130_fd_sc_hd__a21o_2 _0871_ (.A1(net11),
    .A2(_0362_),
    .B1(_0328_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0363_));
 sky130_fd_sc_hd__nand2_2 _0872_ (.A(net7),
    .B(_0363_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0364_));
 sky130_fd_sc_hd__o21ai_2 _0873_ (.A1(_0326_),
    .A2(_0349_),
    .B1(_0358_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0365_));
 sky130_fd_sc_hd__a211o_2 _0874_ (.A1(net10),
    .A2(_0318_),
    .B1(_0326_),
    .C1(_0359_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0366_));
 sky130_fd_sc_hd__o211a_2 _0875_ (.A1(_0357_),
    .A2(_0358_),
    .B1(_0366_),
    .C1(net11),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0367_));
 sky130_fd_sc_hd__o22ai_2 _0876_ (.A1(_0329_),
    .A2(_0352_),
    .B1(_0364_),
    .B2(_0367_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0368_));
 sky130_fd_sc_hd__nand2_2 _0877_ (.A(net4),
    .B(_0368_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0369_));
 sky130_fd_sc_hd__and2_2 _0878_ (.A(_0318_),
    .B(net20),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0370_));
 sky130_fd_sc_hd__and2_2 _0879_ (.A(net14),
    .B(_0370_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0371_));
 sky130_fd_sc_hd__nor2_2 _0880_ (.A(net13),
    .B(_0341_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0372_));
 sky130_fd_sc_hd__o221a_2 _0881_ (.A1(net5),
    .A2(_0371_),
    .B1(_0372_),
    .B2(net8),
    .C1(_0360_),
    ...
    .VPWR(VPWR),
    .X(_0373_));
 sky130_fd_sc_hd__a21o_2 _0882_ (.A1(_0313_),
    .A2(_0315_),
    .B1(_0322_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0374_));
 sky130_fd_sc_hd__o211a_2 _0883_ (.A1(net8),
    .A2(net14),
    .B1(_0361_),
    .C1(_0322_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0375_));
 sky130_fd_sc_hd__o21a_2 _0884_ (.A1(_0373_),
    .A2(_0375_),
    .B1(_0292_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0376_));
 sky130_fd_sc_hd__a21o_2 _0885_ (.A1(net6),
    .A2(_0356_),
    .B1(_0339_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0377_));
 sky130_fd_sc_hd__xnor2_2 _0886_ (.A(_0319_),
    .B(net20),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0378_));
 sky130_fd_sc_hd__and2_2 _0887_ (.A(net14),
    .B(_0378_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0379_));
 sky130_fd_sc_hd__mux2_1 _0888_ (.A0(_0322_),
    .A1(_0378_),
    .S(net14),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0380_));
 sky130_fd_sc_hd__a21o_2 _0889_ (.A1(net8),
    .A2(_0380_),
    .B1(_0338_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0381_));
 sky130_fd_sc_hd__and4_2 _0890_ (.A(_0313_),
    .B(_0315_),
    .C(_0322_),
    .D(net14),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0382_));
 sky130_fd_sc_hd__a211o_2 _0891_ (.A1(net8),
    .A2(_0380_),
    .B1(_0382_),
    .C1(_0338_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0383_));
 sky130_fd_sc_hd__a31o_2 _0892_ (.A1(net21),
    .A2(_0377_),
    .A3(_0383_),
    .B1(net11),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0384_));
 sky130_fd_sc_hd__a21o_2 _0893_ (.A1(_0355_),
    .A2(_0374_),
    .B1(_0339_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0385_));
 sky130_fd_sc_hd__a21o_2 _0894_ (.A1(_0381_),
    .A2(_0385_),
    .B1(_0334_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0386_));
 sky130_fd_sc_hd__o221a_2 _0895_ (.A1(net5),
    .A2(_0371_),
    .B1(_0372_),
    .B2(net8),
    .C1(_0335_),
    ...
    .VPWR(VPWR),
    .X(_0387_));
 sky130_fd_sc_hd__nand2_2 _0896_ (.A(_0291_),
    .B(net12),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0388_));
 sky130_fd_sc_hd__a311o_2 _0897_ (.A1(_0336_),
    .A2(_0355_),
    .A3(_0374_),
    .B1(_0387_),
    .C1(_0388_),
    ...
    .VPWR(VPWR),
    .X(_0389_));
 sky130_fd_sc_hd__o211ai_2 _0898_ (.A1(_0376_),
    .A2(_0384_),
    .B1(_0386_),
    .C1(_0389_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0390_));
 sky130_fd_sc_hd__a211o_2 _0899_ (.A1(_0319_),
    .A2(_0345_),
    .B1(_0343_),
    .C1(net8),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0391_));
 sky130_fd_sc_hd__a21oi_2 _0900_ (.A1(net6),
    .A2(_0391_),
    .B1(_0362_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0392_));
 sky130_fd_sc_hd__or4b_2 _0901_ (.A(_0312_),
    .B(net13),
    .C(_0314_),
    .D_N(_0321_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0393_));
 sky130_fd_sc_hd__nand2_2 _0902_ (.A(net10),
    .B(_0372_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0394_));
 sky130_fd_sc_hd__a41o_2 _0903_ (.A1(_0326_),
    .A2(_0358_),
    .A3(_0362_),
    .A4(_0394_),
    .B1(net11),
    ...
    .VPWR(VPWR),
    .X(_0395_));
 sky130_fd_sc_hd__nor2_2 _0904_ (.A(_0328_),
    .B(_0358_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0396_));
 sky130_fd_sc_hd__and3_2 _0905_ (.A(_0344_),
    .B(_0350_),
    .C(_0358_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0397_));
 sky130_fd_sc_hd__o21ai_2 _0906_ (.A1(_0328_),
    .A2(_0362_),
    .B1(_0397_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0398_));
 sky130_fd_sc_hd__o311a_2 _0907_ (.A1(_0392_),
    .A2(_0395_),
    .A3(_0396_),
    .B1(_0398_),
    .C1(net7),
    ...
    .VPWR(VPWR),
    .X(_0399_));
 sky130_fd_sc_hd__a211o_2 _0908_ (.A1(_0332_),
    .A2(_0390_),
    .B1(_0399_),
    .C1(net4),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0400_));
 sky130_fd_sc_hd__a21o_2 _0909_ (.A1(_0369_),
    .A2(_0400_),
    .B1(_0267_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0401_));
 sky130_fd_sc_hd__xor2_2 _0910_ (.A(_0304_),
    .B(_0305_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0402_));
 sky130_fd_sc_hd__or3_2 _0911_ (.A(_0312_),
    .B(_0314_),
    .C(_0370_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0403_));
 sky130_fd_sc_hd__o211a_2 _0912_ (.A1(net10),
    .A2(_0379_),
    .B1(_0403_),
    .C1(_0339_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0404_));
 sky130_fd_sc_hd__a31oi_2 _0913_ (.A1(net8),
    .A2(_0319_),
    .A3(_0345_),
    .B1(_0371_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0405_));
 sky130_fd_sc_hd__nand2_2 _0914_ (.A(net10),
    .B(_0354_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0406_));
 sky130_fd_sc_hd__nand2_2 _0915_ (.A(_0405_),
    .B(_0406_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0407_));
 sky130_fd_sc_hd__a21oi_2 _0916_ (.A1(_0338_),
    .A2(_0407_),
    .B1(_0404_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0408_));
 sky130_fd_sc_hd__or2_2 _0917_ (.A(_0324_),
    .B(_0378_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0409_));
 sky130_fd_sc_hd__o221a_2 _0918_ (.A1(_0321_),
    .A2(_0325_),
    .B1(_0354_),
    .B2(net10),
    .C1(_0409_),
    ...
    .VPWR(VPWR),
    .X(_0410_));
 sky130_fd_sc_hd__a211oi_2 _0919_ (.A1(_0338_),
    .A2(_0410_),
    .B1(_0404_),
    .C1(_0292_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0411_));
 sky130_fd_sc_hd__or2_2 _0920_ (.A(_0361_),
    .B(_0393_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0412_));
 sky130_fd_sc_hd__o211a_2 _0921_ (.A1(_0360_),
    .A2(_0405_),
    .B1(_0412_),
    .C1(_0292_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0413_));
 sky130_fd_sc_hd__a21o_2 _0922_ (.A1(_0335_),
    .A2(_0393_),
    .B1(_0388_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0414_));
 sky130_fd_sc_hd__a31o_2 _0923_ (.A1(_0336_),
    .A2(_0405_),
    .A3(_0406_),
    .B1(_0414_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0415_));
 sky130_fd_sc_hd__o311a_2 _0924_ (.A1(net11),
    .A2(_0411_),
    .A3(_0413_),
    .B1(_0415_),
    .C1(_0332_),
    ...
    .VPWR(VPWR),
    .X(_0416_));
 sky130_fd_sc_hd__o21ai_2 _0925_ (.A1(_0334_),
    .A2(_0408_),
    .B1(_0416_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0417_));
 sky130_fd_sc_hd__o22a_2 _0926_ (.A1(net10),
    .A2(_0354_),
    .B1(_0403_),
    .B2(_0342_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0418_));
 sky130_fd_sc_hd__o21ai_2 _0927_ (.A1(_0319_),
    .A2(_0393_),
    .B1(_0359_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0419_));
 sky130_fd_sc_hd__a41oi_2 _0928_ (.A1(_0358_),
    .A2(_0362_),
    .A3(_0393_),
    .A4(_0406_),
    .B1(net11),
    ...
    .VPWR(VPWR),
    .Y(_0420_));
 sky130_fd_sc_hd__o211a_2 _0929_ (.A1(_0362_),
    .A2(_0418_),
    .B1(_0419_),
    .C1(_0420_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0421_));
 sky130_fd_sc_hd__a21o_2 _0930_ (.A1(net10),
    .A2(_0371_),
    .B1(_0362_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0422_));
 sky130_fd_sc_hd__a211o_2 _0931_ (.A1(_0397_),
    .A2(_0422_),
    .B1(_0421_),
    .C1(_0332_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0423_));
 sky130_fd_sc_hd__a21oi_2 _0932_ (.A1(_0417_),
    .A2(_0423_),
    .B1(net4),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0424_));
 sky130_fd_sc_hd__o21a_2 _0933_ (.A1(_0319_),
    .A2(_0393_),
    .B1(_0292_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0425_));
 sky130_fd_sc_hd__a22o_2 _0934_ (.A1(net11),
    .A2(_0359_),
    .B1(_0371_),
    .B2(net10),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0426_));
 sky130_fd_sc_hd__o211ai_2 _0935_ (.A1(_0334_),
    .A2(_0410_),
    .B1(_0426_),
    .C1(net7),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0427_));
 sky130_fd_sc_hd__o211a_2 _0936_ (.A1(_0352_),
    .A2(_0425_),
    .B1(_0427_),
    .C1(net4),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0428_));
 sky130_fd_sc_hd__o311a_2 _0937_ (.A1(_0268_),
    .A2(_0424_),
    .A3(_0428_),
    .B1(_0401_),
    .C1(_0402_),
    ...
    .VPWR(VPWR),
    .X(_0429_));
 sky130_fd_sc_hd__o22a_2 _0938_ (.A1(net5),
    .A2(_0371_),
    .B1(_0379_),
    .B2(net8),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0430_));
 sky130_fd_sc_hd__a21oi_2 _0939_ (.A1(_0318_),
    .A2(_0325_),
    .B1(_0321_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0431_));
 sky130_fd_sc_hd__o211a_2 _0940_ (.A1(net8),
    .A2(_0345_),
    .B1(_0361_),
    .C1(_0431_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0432_));
 sky130_fd_sc_hd__a211o_2 _0941_ (.A1(_0360_),
    .A2(_0430_),
    .B1(_0432_),
    .C1(_0291_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0433_));
 sky130_fd_sc_hd__a211o_2 _0942_ (.A1(net14),
    .A2(_0346_),
    .B1(_0312_),
    .C1(_0314_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0434_));
 sky130_fd_sc_hd__o22a_2 _0943_ (.A1(net5),
    .A2(_0372_),
    .B1(_0434_),
    .B2(_0340_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0435_));
 sky130_fd_sc_hd__o211a_2 _0944_ (.A1(_0345_),
    .A2(_0355_),
    .B1(net5),
    .C1(_0339_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0436_));
 sky130_fd_sc_hd__a211o_2 _0945_ (.A1(_0338_),
    .A2(_0435_),
    .B1(_0436_),
    .C1(_0292_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0437_));
 sky130_fd_sc_hd__a21o_2 _0946_ (.A1(_0433_),
    .A2(_0437_),
    .B1(net12),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0438_));
 sky130_fd_sc_hd__and3_2 _0947_ (.A(net22),
    .B(_0431_),
    .C(_0434_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0439_));
 sky130_fd_sc_hd__a211o_2 _0948_ (.A1(_0335_),
    .A2(_0430_),
    .B1(_0439_),
    .C1(_0388_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0440_));
 sky130_fd_sc_hd__o211a_2 _0949_ (.A1(net9),
    .A2(_0346_),
    .B1(net5),
    .C1(_0339_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0441_));
 sky130_fd_sc_hd__and3_2 _0950_ (.A(_0338_),
    .B(_0431_),
    .C(_0434_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0442_));
 sky130_fd_sc_hd__o31a_2 _0951_ (.A1(_0334_),
    .A2(_0441_),
    .A3(_0442_),
    .B1(_0440_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0443_));
 sky130_fd_sc_hd__and3_2 _0952_ (.A(_0267_),
    .B(_0438_),
    .C(_0443_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0444_));
 sky130_fd_sc_hd__nand2_2 _0953_ (.A(net5),
    .B(_0434_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0445_));
 sky130_fd_sc_hd__a21o_2 _0954_ (.A1(net5),
    .A2(_0434_),
    .B1(_0372_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0446_));
 sky130_fd_sc_hd__o2111a_2 _0955_ (.A1(net9),
    .A2(_0409_),
    .B1(_0393_),
    .C1(_0374_),
    .D1(_0339_),
    ...
    .VPWR(VPWR),
    .X(_0447_));
 sky130_fd_sc_hd__a211o_2 _0956_ (.A1(_0338_),
    .A2(_0446_),
    .B1(_0447_),
    .C1(_0292_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0448_));
 sky130_fd_sc_hd__o21a_2 _0957_ (.A1(net6),
    .A2(_0371_),
    .B1(_0434_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0449_));
 sky130_fd_sc_hd__o221a_2 _0958_ (.A1(net9),
    .A2(_0345_),
    .B1(_0348_),
    .B2(net6),
    .C1(_0361_),
    ...
    .VPWR(VPWR),
    .X(_0450_));
 sky130_fd_sc_hd__a211o_2 _0959_ (.A1(_0360_),
    .A2(_0449_),
    .B1(_0450_),
    .C1(_0291_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0451_));
 sky130_fd_sc_hd__a21o_2 _0960_ (.A1(_0448_),
    .A2(_0451_),
    .B1(net12),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0452_));
 sky130_fd_sc_hd__o22a_2 _0961_ (.A1(_0348_),
    .A2(net6),
    .B1(_0379_),
    .B2(net9),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0453_));
 sky130_fd_sc_hd__mux2_1 _0962_ (.A0(_0449_),
    .A1(_0453_),
    .S(net22),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0454_));
 sky130_fd_sc_hd__o311a_2 _0963_ (.A1(net9),
    .A2(_0343_),
    .A3(_0346_),
    .B1(_0374_),
    .C1(_0339_),
    ...
    .VPWR(VPWR),
    .X(_0455_));
 sky130_fd_sc_hd__a211o_2 _0964_ (.A1(_0338_),
    .A2(_0453_),
    .B1(_0455_),
    .C1(_0334_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0456_));
 sky130_fd_sc_hd__o211a_2 _0965_ (.A1(_0388_),
    .A2(_0454_),
    .B1(_0456_),
    .C1(_0268_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0457_));
 sky130_fd_sc_hd__a21o_2 _0966_ (.A1(_0452_),
    .A2(_0457_),
    .B1(_0290_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0458_));
 sky130_fd_sc_hd__or3b_2 _0967_ (.A(_0338_),
    .B(_0388_),
    .C_N(_0344_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0459_));
 sky130_fd_sc_hd__o211ai_2 _0968_ (.A1(_0334_),
    .A2(_0445_),
    .B1(_0459_),
    .C1(_0290_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0460_));
 sky130_fd_sc_hd__o211a_2 _0969_ (.A1(_0444_),
    .A2(_0458_),
    .B1(_0460_),
    .C1(_0332_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0461_));
 sky130_fd_sc_hd__o211a_2 _0970_ (.A1(net9),
    .A2(_0409_),
    .B1(_0393_),
    .C1(_0267_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0462_));
 sky130_fd_sc_hd__o21a_2 _0971_ (.A1(_0345_),
    .A2(_0355_),
    .B1(_0268_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0463_));
 sky130_fd_sc_hd__or3_2 _0972_ (.A(net12),
    .B(_0462_),
    .C(_0463_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0464_));
 sky130_fd_sc_hd__nand2b_2 _0973_ (.A_N(_0328_),
    .B(_0350_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0465_));
 sky130_fd_sc_hd__o211a_2 _0974_ (.A1(net5),
    .A2(_0372_),
    .B1(_0465_),
    .C1(_0361_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0466_));
 sky130_fd_sc_hd__a211o_2 _0975_ (.A1(net10),
    .A2(_0380_),
    .B1(net11),
    .C1(_0327_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0467_));
 sky130_fd_sc_hd__a221o_2 _0976_ (.A1(_0464_),
    .A2(_0466_),
    .B1(_0467_),
    .B2(_0360_),
    .C1(_0292_),
    ...
    .VPWR(VPWR),
    .X(_0468_));
 sky130_fd_sc_hd__a21o_2 _0977_ (.A1(net5),
    .A2(_0434_),
    .B1(_0358_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0469_));
 sky130_fd_sc_hd__a21bo_2 _0978_ (.A1(_0344_),
    .A2(_0358_),
    .B1_N(net12),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0470_));
 sky130_fd_sc_hd__o311a_2 _0979_ (.A1(net21),
    .A2(_0336_),
    .A3(_0467_),
    .B1(_0469_),
    .C1(_0470_),
    ...
    .VPWR(VPWR),
    .X(_0471_));
 sky130_fd_sc_hd__and3b_2 _0980_ (.A_N(net4),
    .B(_0468_),
    .C(_0471_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0472_));
 sky130_fd_sc_hd__mux2_1 _0981_ (.A0(_0435_),
    .A1(_0446_),
    .S(_0268_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0473_));
 sky130_fd_sc_hd__a22o_2 _0982_ (.A1(_0316_),
    .A2(_0348_),
    .B1(_0363_),
    .B2(_0365_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0474_));
 sky130_fd_sc_hd__o211a_2 _0983_ (.A1(_0358_),
    .A2(_0473_),
    .B1(_0474_),
    .C1(net4),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0475_));
 sky130_fd_sc_hd__o21a_2 _0984_ (.A1(_0472_),
    .A2(_0475_),
    .B1(net7),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0476_));
 sky130_fd_sc_hd__or3_2 _0985_ (.A(_0402_),
    .B(_0461_),
    .C(_0476_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0477_));
 sky130_fd_sc_hd__xnor2_2 _0986_ (.A(\logo_top[9] ),
    .B(\pix_y[9] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0478_));
 sky130_fd_sc_hd__o21ai_2 _0987_ (.A1(\logo_top[8] ),
    .A2(_0082_),
    .B1(_0478_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0479_));
 sky130_fd_sc_hd__nor2_2 _0988_ (.A(_0066_),
    .B(\pix_y[7] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0480_));
 sky130_fd_sc_hd__a21oi_2 _0989_ (.A1(_0270_),
    .A2(_0289_),
    .B1(_0269_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0481_));
 sky130_fd_sc_hd__nand2_2 _0990_ (.A(_0066_),
    .B(\pix_y[7] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0482_));
 sky130_fd_sc_hd__o21ai_2 _0991_ (.A1(_0480_),
    .A2(_0481_),
    .B1(_0482_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0483_));
 sky130_fd_sc_hd__a21oi_2 _0992_ (.A1(_0072_),
    .A2(\pix_x[6] ),
    .B1(_0312_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0484_));
 sky130_fd_sc_hd__nor2_2 _0993_ (.A(_0071_),
    .B(\pix_x[7] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0485_));
 sky130_fd_sc_hd__and2_2 _0994_ (.A(_0071_),
    .B(\pix_x[7] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0486_));
 sky130_fd_sc_hd__nor2_2 _0995_ (.A(_0485_),
    .B(_0486_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0487_));
 sky130_fd_sc_hd__or2_2 _0996_ (.A(_0070_),
    .B(\pix_x[8] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0488_));
 sky130_fd_sc_hd__nand2_2 _0997_ (.A(_0070_),
    .B(\pix_x[8] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0489_));
 sky130_fd_sc_hd__nand2_2 _0998_ (.A(_0488_),
    .B(_0489_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0490_));
 sky130_fd_sc_hd__a21o_2 _0999_ (.A1(_0485_),
    .A2(_0490_),
    .B1(_0486_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0491_));
 sky130_fd_sc_hd__mux2_1 _1000_ (.A0(_0487_),
    .A1(_0491_),
    .S(_0484_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0492_));
 sky130_fd_sc_hd__xnor2_2 _1001_ (.A(\logo_left[9] ),
    .B(\pix_x[9] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0493_));
 sky130_fd_sc_hd__xnor2_2 _1002_ (.A(_0488_),
    .B(_0493_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0494_));
 sky130_fd_sc_hd__nand2_2 _1003_ (.A(\logo_top[8] ),
    .B(_0082_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0495_));
 sky130_fd_sc_hd__xnor2_2 _1004_ (.A(_0478_),
    .B(_0495_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0496_));
 sky130_fd_sc_hd__o2111a_2 _1005_ (.A1(_0481_),
    .A2(_0482_),
    .B1(_0492_),
    .C1(_0494_),
    .D1(_0496_),
    ...
    .VPWR(VPWR),
    .X(_0497_));
 sky130_fd_sc_hd__o21bai_2 _1006_ (.A1(_0484_),
    .A2(_0485_),
    .B1_N(_0486_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0498_));
 sky130_fd_sc_hd__nand2_2 _1007_ (.A(_0490_),
    .B(_0498_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0499_));
 sky130_fd_sc_hd__and2_2 _1008_ (.A(_0480_),
    .B(_0481_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0500_));
 sky130_fd_sc_hd__mux2_1 _1009_ (.A0(_0483_),
    .A1(_0500_),
    .S(_0479_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0501_));
 sky130_fd_sc_hd__a31o_2 _1010_ (.A1(_0497_),
    .A2(_0499_),
    .A3(_0501_),
    .B1(net2),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0502_));
 sky130_fd_sc_hd__o21ai_2 _1011_ (.A1(\pix_x[7] ),
    .A2(\pix_x[8] ),
    .B1(\pix_x[9] ),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0503_));
 sky130_fd_sc_hd__and4b_2 _1012_ (.A_N(\pix_y[9] ),
    .B(net32),
    .C(_0087_),
    .D(_0503_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0504_));
 sky130_fd_sc_hd__and4b_2 _1013_ (.A_N(_0429_),
    .B(_0477_),
    .C(_0502_),
    .D(_0504_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0505_));
 sky130_fd_sc_hd__nand2_2 _1014_ (.A(\color_index[0] ),
    .B(net3),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0506_));
 sky130_fd_sc_hd__o21a_2 _1015_ (.A1(\color_index[2] ),
    .A2(_0506_),
    .B1(_0505_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0057_));
 sky130_fd_sc_hd__and2_2 _1016_ (.A(\color_index[2] ),
    .B(\color_index[0] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0507_));
 sky130_fd_sc_hd__nand2_2 _1017_ (.A(net74),
    .B(net3),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0508_));
 sky130_fd_sc_hd__o21a_2 _1018_ (.A1(_0507_),
    .A2(_0508_),
    .B1(_0505_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0058_));
 sky130_fd_sc_hd__or2_2 _1019_ (.A(\color_index[2] ),
    .B(_0508_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0509_));
 sky130_fd_sc_hd__or3b_2 _1020_ (.A(\color_index[0] ),
    .B(_0086_),
    .C_N(_0509_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0510_));
 sky130_fd_sc_hd__o311a_2 _1021_ (.A1(\color_index[2] ),
    .A2(_0063_),
    .A3(_0506_),
    .B1(_0510_),
    .C1(_0505_),
    ...
    .VPWR(VPWR),
    .X(_0059_));
 sky130_fd_sc_hd__nor2_2 _1022_ (.A(\color_index[2] ),
    .B(\color_index[0] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0511_));
 sky130_fd_sc_hd__nor2_2 _1023_ (.A(_0507_),
    .B(_0511_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0512_));
 sky130_fd_sc_hd__nand2_2 _1024_ (.A(_0509_),
    .B(_0512_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0513_));
 sky130_fd_sc_hd__o21a_2 _1025_ (.A1(_0086_),
    .A2(_0513_),
    .B1(_0505_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0060_));
 sky130_fd_sc_hd__o31a_2 _1026_ (.A1(\color_index[2] ),
    .A2(\color_index[0] ),
    .A3(_0086_),
    .B1(_0505_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0061_));
 sky130_fd_sc_hd__o31a_2 _1027_ (.A1(net74),
    .A2(_0086_),
    .A3(_0512_),
    .B1(_0505_),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__dfxtp_2 _1028_ (.CLK(clknet_3_1__leaf_clk),
    ...
    .VPWR(VPWR),
    .Q(\pix_y[0] ));
 sky130_fd_sc_hd__dfxtp_2 _1029_ (.CLK(clknet_3_4__leaf_clk),
    .D(_0003_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\pix_y[1] ));
 sky130_fd_sc_hd__dfxtp_2 _1030_ (.CLK(clknet_3_4__leaf_clk),
    .D(_0004_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\pix_y[2] ));
 sky130_fd_sc_hd__dfxtp_2 _1031_ (.CLK(clknet_3_4__leaf_clk),
    .D(_0005_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\pix_y[3] ));
 sky130_fd_sc_hd__dfxtp_2 _1032_ (.CLK(clknet_3_1__leaf_clk),
    .D(_0006_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\pix_y[4] ));
 sky130_fd_sc_hd__dfxtp_2 _1033_ (.CLK(clknet_3_1__leaf_clk),
    .D(_0007_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\pix_y[5] ));
 sky130_fd_sc_hd__dfxtp_2 _1034_ (.CLK(clknet_3_3__leaf_clk),
    .D(_0008_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__dfxtp_2 _1035_ (.CLK(clknet_3_6__leaf_clk),
    ...
    .VPWR(VPWR),
    .Q(\pix_y[7] ));
 sky130_fd_sc_hd__dfxtp_2 _1036_ (.CLK(clknet_3_3__leaf_clk),
    .D(_0010_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\pix_y[8] ));
 sky130_fd_sc_hd__dfxtp_2 _1037_ (.CLK(clknet_3_3__leaf_clk),
    .D(_0011_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\pix_y[9] ));
 sky130_fd_sc_hd__dfxtp_2 _1038_ (.CLK(clknet_3_1__leaf_clk),
    .D(_0012_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\pix_x[0] ));
 sky130_fd_sc_hd__dfxtp_2 _1039_ (.CLK(clknet_3_1__leaf_clk),
    .D(_0013_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\pix_x[1] ));
 sky130_fd_sc_hd__dfxtp_2 _1040_ (.CLK(clknet_3_1__leaf_clk),
    .D(net66),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\pix_x[2] ));
 sky130_fd_sc_hd__dfxtp_2 _1041_ (.CLK(clknet_3_1__leaf_clk),
    .D(_0015_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\pix_x[3] ));
 sky130_fd_sc_hd__dfxtp_2 _1042_ (.CLK(clknet_3_2__leaf_clk),
    .D(_0016_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\pix_x[4] ));
 sky130_fd_sc_hd__dfxtp_2 _1043_ (.CLK(clknet_3_1__leaf_clk),
    .D(_0017_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\pix_x[5] ));
 sky130_fd_sc_hd__dfxtp_2 _1044_ (.CLK(clknet_3_2__leaf_clk),
    .D(_0018_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\pix_x[6] ));
 sky130_fd_sc_hd__dfxtp_2 _1045_ (.CLK(clknet_3_2__leaf_clk),
    .D(_0019_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__dfxtp_2 _1047_ (.CLK(clknet_3_2__leaf_clk),
    ...
    .VPWR(VPWR),
    .Q(\pix_x[9] ));
 sky130_fd_sc_hd__dfxtp_2 _1048_ (.CLK(clknet_3_4__leaf_clk),
    .D(_0022_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\prev_y[0] ));
 sky130_fd_sc_hd__dfxtp_2 _1049_ (.CLK(clknet_3_4__leaf_clk),
    .D(_0023_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__dfxtp_2 _1050_ (.CLK(clknet_3_5__leaf_clk),
    ...
    .VPWR(VPWR),
    .Q(\prev_y[2] ));
 sky130_fd_sc_hd__dfxtp_2 _1051_ (.CLK(clknet_3_4__leaf_clk),
    .D(net53),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__dfxtp_2 _1052_ (.CLK(clknet_3_5__leaf_clk),
    ...
    .VPWR(VPWR),
    .Q(\prev_y[4] ));
 sky130_fd_sc_hd__dfxtp_2 _1053_ (.CLK(clknet_3_5__leaf_clk),
    .D(_0027_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\prev_y[5] ));
 sky130_fd_sc_hd__dfxtp_2 _1054_ (.CLK(clknet_3_3__leaf_clk),
    .D(_0028_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\prev_y[6] ));
 sky130_fd_sc_hd__dfxtp_2 _1055_ (.CLK(clknet_3_4__leaf_clk),
    .D(_0029_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\prev_y[7] ));
 sky130_fd_sc_hd__dfxtp_2 _1056_ (.CLK(clknet_3_4__leaf_clk),
    .D(net55),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__dfxtp_2 _1057_ (.CLK(clknet_3_3__leaf_clk),
    ...
    .VPWR(VPWR),
    .Q(\prev_y[9] ));
 sky130_fd_sc_hd__dfxtp_2 _1058_ (.CLK(clknet_3_0__leaf_clk),
    .D(_0032_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\logo_left[0] ));
 sky130_fd_sc_hd__dfxtp_2 _1059_ (.CLK(clknet_3_0__leaf_clk),
    .D(_0033_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__dfxtp_2 _1060_ (.CLK(clknet_3_0__leaf_clk),
    ...
    .VPWR(VPWR),
    .Q(\logo_left[2] ));
 sky130_fd_sc_hd__dfxtp_2 _1061_ (.CLK(clknet_3_0__leaf_clk),
    .D(_0035_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\logo_left[3] ));
 sky130_fd_sc_hd__dfxtp_2 _1062_ (.CLK(clknet_3_0__leaf_clk),
    .D(_0036_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\logo_left[4] ));
 sky130_fd_sc_hd__dfxtp_2 _1063_ (.CLK(clknet_3_0__leaf_clk),
    .D(_0037_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\logo_left[5] ));
 sky130_fd_sc_hd__dfxtp_2 _1064_ (.CLK(clknet_3_0__leaf_clk),
    .D(_0038_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\logo_left[6] ));
 sky130_fd_sc_hd__dfxtp_2 _1065_ (.CLK(clknet_3_2__leaf_clk),
    .D(_0039_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\logo_left[7] ));
 sky130_fd_sc_hd__dfxtp_2 _1066_ (.CLK(clknet_3_2__leaf_clk),
    .D(_0040_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\logo_left[8] ));
 sky130_fd_sc_hd__dfxtp_2 _1067_ (.CLK(clknet_3_0__leaf_clk),
    .D(_0041_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\logo_left[9] ));
 sky130_fd_sc_hd__dfxtp_2 _1068_ (.CLK(clknet_3_5__leaf_clk),
    .D(_0042_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\logo_top[0] ));
 sky130_fd_sc_hd__dfxtp_2 _1069_ (.CLK(clknet_3_5__leaf_clk),
    .D(_0043_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\logo_top[1] ));
 sky130_fd_sc_hd__dfxtp_2 _1070_ (.CLK(clknet_3_5__leaf_clk),
    .D(_0044_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\logo_top[2] ));
 sky130_fd_sc_hd__dfxtp_2 _1071_ (.CLK(clknet_3_5__leaf_clk),
    .D(_0045_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\logo_top[3] ));
 sky130_fd_sc_hd__dfxtp_2 _1072_ (.CLK(clknet_3_5__leaf_clk),
    .D(_0046_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\logo_top[4] ));
 sky130_fd_sc_hd__dfxtp_2 _1073_ (.CLK(clknet_3_7__leaf_clk),
    .D(_0047_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\logo_top[5] ));
 sky130_fd_sc_hd__dfxtp_2 _1074_ (.CLK(clknet_3_7__leaf_clk),
    .D(_0048_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\logo_top[6] ));
 sky130_fd_sc_hd__dfxtp_2 _1075_ (.CLK(clknet_3_7__leaf_clk),
    .D(_0049_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\logo_top[7] ));
 sky130_fd_sc_hd__dfxtp_2 _1076_ (.CLK(clknet_3_6__leaf_clk),
    .D(_0050_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\logo_top[8] ));
 sky130_fd_sc_hd__dfxtp_2 _1077_ (.CLK(clknet_3_6__leaf_clk),
    .D(_0051_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\logo_top[9] ));
 sky130_fd_sc_hd__dfxtp_2 _1078_ (.CLK(clknet_3_2__leaf_clk),
    .D(_0052_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(dir_x));
 sky130_fd_sc_hd__dfxtp_2 _1079_ (.CLK(clknet_3_7__leaf_clk),
    .D(_0053_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(dir_y));
 sky130_fd_sc_hd__dfxtp_2 _1080_ (.CLK(clknet_3_7__leaf_clk),
    .D(_0054_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\color_index[0] ));
 sky130_fd_sc_hd__dfxtp_2 _1081_ (.CLK(clknet_3_7__leaf_clk),
    .D(_0055_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\color_index[1] ));
 sky130_fd_sc_hd__dfxtp_2 _1082_ (.CLK(clknet_3_7__leaf_clk),
    .D(net68),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\color_index[2] ));
 sky130_fd_sc_hd__dfxtp_2 _1083_ (.CLK(clknet_3_6__leaf_clk),
    .D(_0057_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(uo_out[6]));
 sky130_fd_sc_hd__dfxtp_2 _1084_ (.CLK(clknet_3_6__leaf_clk),
    .D(_0058_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(uo_out[2]));
 sky130_fd_sc_hd__dfxtp_2 _1085_ (.CLK(clknet_3_3__leaf_clk),
    .D(_0059_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(uo_out[5]));
 sky130_fd_sc_hd__dfxtp_2 _1086_ (.CLK(clknet_3_6__leaf_clk),
    .D(_0060_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(uo_out[1]));
 sky130_fd_sc_hd__dfxtp_2 _1087_ (.CLK(clknet_3_3__leaf_clk),
    .D(_0061_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(uo_out[4]));
 sky130_fd_sc_hd__dfxtp_2 _1088_ (.CLK(clknet_3_6__leaf_clk),
    .D(_0062_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(uo_out[0]));
 sky130_fd_sc_hd__dfxtp_2 _1089_ (.CLK(clknet_3_3__leaf_clk),
    .D(_0000_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(hsync));
 sky130_fd_sc_hd__dfxtp_2 _1090_ (.CLK(clknet_3_6__leaf_clk),
    .D(_0001_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__buf_2 _1107_ (.A(\vga_sync_gen.vsync ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(uo_out[3]));
 sky130_fd_sc_hd__buf_2 _1108_ (.A(hsync),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__clkbuf_4 clkload0 (.A(clknet_3_7__leaf_clk),
    ...
    .VPB(VPWR),
    .VPWR(VPWR));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout10 (.A(_0316_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net10));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout11 (.A(_0333_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net11));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout12 (.A(_0333_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net12));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout13 (.A(_0325_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net13));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout14 (.A(_0324_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net14));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout15 (.A(_0152_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net15));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout16 (.A(_0150_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net16));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout17 (.A(_0150_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net17));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout18 (.A(_0103_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net18));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout19 (.A(_0103_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net19));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout20 (.A(_0321_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net20));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout23 (.A(_0065_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net23));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout24 (.A(dir_y),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net24));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout25 (.A(dir_x),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net25));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout28 (.A(net34),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout30 (.A(net33),
    ...
    .VPWR(VPWR),
    .X(net30));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout31 (.A(net34),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout32 (.A(net34),
    ...
    .VPWR(VPWR),
    .X(net32));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout33 (.A(net1),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net33));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout5 (.A(net6),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net5));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout6 (.A(_0353_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net6));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout8 (.A(_0317_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net8));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout9 (.A(_0317_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net9));
 sky130_fd_sc_hd__dlygate4sd3_1 hold50 (.A(\prev_y[5] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__dlygate4sd3_1 hold51 (.A(\prev_y[7] ),
    ...
    .VPWR(VPWR),
    .X(net51));
 sky130_fd_sc_hd__dlygate4sd3_1 hold52 (.A(\prev_y[3] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net52));
 sky130_fd_sc_hd__dlygate4sd3_1 hold53 (.A(_0025_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net53));
 sky130_fd_sc_hd__dlygate4sd3_1 hold54 (.A(\prev_y[8] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net54));
 sky130_fd_sc_hd__dlygate4sd3_1 hold55 (.A(_0030_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__dlygate4sd3_1 hold56 (.A(\prev_y[1] ),
    ...
    .VPWR(VPWR),
    .X(net56));
 sky130_fd_sc_hd__dlygate4sd3_1 hold57 (.A(\prev_y[6] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net57));
 sky130_fd_sc_hd__dlygate4sd3_1 hold58 (.A(dir_y),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net58));
 sky130_fd_sc_hd__dlygate4sd3_1 hold59 (.A(\prev_y[0] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net59));
 sky130_fd_sc_hd__dlygate4sd3_1 hold60 (.A(\prev_y[2] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net60));
 sky130_fd_sc_hd__dlygate4sd3_1 hold61 (.A(\prev_y[4] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net61));
 sky130_fd_sc_hd__dlygate4sd3_1 hold62 (.A(\prev_y[9] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net62));
 sky130_fd_sc_hd__dlygate4sd3_1 hold63 (.A(\logo_left[0] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net63));
 sky130_fd_sc_hd__dlygate4sd3_1 hold64 (.A(dir_x),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net64));
 sky130_fd_sc_hd__dlygate4sd3_1 hold65 (.A(\pix_x[2] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net65));
 sky130_fd_sc_hd__dlygate4sd3_1 hold66 (.A(_0014_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net66));
 sky130_fd_sc_hd__dlygate4sd3_1 hold67 (.A(\color_index[2] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net67));
 sky130_fd_sc_hd__dlygate4sd3_1 hold68 (.A(_0056_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net68));
 sky130_fd_sc_hd__dlygate4sd3_1 hold69 (.A(\pix_x[9] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net69));
 sky130_fd_sc_hd__dlygate4sd3_1 hold70 (.A(\pix_x[3] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net70));
 sky130_fd_sc_hd__dlygate4sd3_1 hold71 (.A(\pix_y[3] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__dlygate4sd3_1 hold72 (.A(\pix_x[5] ),
    ...
    .VPWR(VPWR),
    .X(net72));
 sky130_fd_sc_hd__dlygate4sd3_1 hold73 (.A(\pix_x[4] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net73));
 sky130_fd_sc_hd__dlygate4sd3_1 hold74 (.A(\color_index[1] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net74));
 sky130_fd_sc_hd__dlygate4sd3_1 hold75 (.A(\logo_top[3] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net75));
 sky130_fd_sc_hd__dlygate4sd3_1 hold76 (.A(\pix_x[0] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net76));
 sky130_fd_sc_hd__dlygate4sd3_1 hold77 (.A(\logo_left[9] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net77));
 sky130_fd_sc_hd__dlygate4sd3_1 hold78 (.A(\pix_x[8] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net78));
 sky130_fd_sc_hd__dlygate4sd3_1 hold79 (.A(\color_index[1] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__clkdlybuf4s25_1 input3 (.A(ui_in[1]),
    ...
    .VPWR(VPWR),
    .X(net3));
 sky130_fd_sc_hd__buf_4 load_slew26 (.A(net27),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net26));
 sky130_fd_sc_hd__buf_4 load_slew27 (.A(net25),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net27));
 sky130_fd_sc_hd__buf_4 load_slew29 (.A(net28),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__clkbuf_4 load_slew34 (.A(net33),
    ...
    .VPWR(VPWR),
    .X(net34));
 sky130_fd_sc_hd__clkbuf_2 max_cap21 (.A(_0291_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__clkbuf_2 max_cap22 (.A(_0336_),
    ...
    .VPWR(VPWR),
    .X(net22));
 sky130_fd_sc_hd__clkbuf_2 max_cap4 (.A(_0290_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net4));
 sky130_fd_sc_hd__conb_1 tt_um_eric_lcc (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net));
 sky130_fd_sc_hd__conb_1 tt_um_eric_lcc_35 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net35));
 sky130_fd_sc_hd__conb_1 tt_um_eric_lcc_36 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net36));
 sky130_fd_sc_hd__conb_1 tt_um_eric_lcc_37 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net37));
 sky130_fd_sc_hd__conb_1 tt_um_eric_lcc_38 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net38));
 sky130_fd_sc_hd__conb_1 tt_um_eric_lcc_39 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net39));
 sky130_fd_sc_hd__conb_1 tt_um_eric_lcc_40 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net40));
 sky130_fd_sc_hd__conb_1 tt_um_eric_lcc_41 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net41));
 sky130_fd_sc_hd__conb_1 tt_um_eric_lcc_42 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net42));
 sky130_fd_sc_hd__conb_1 tt_um_eric_lcc_43 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net43));
 sky130_fd_sc_hd__conb_1 tt_um_eric_lcc_44 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net44));
 sky130_fd_sc_hd__conb_1 tt_um_eric_lcc_45 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net45));
 sky130_fd_sc_hd__conb_1 tt_um_eric_lcc_46 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net46));
 sky130_fd_sc_hd__conb_1 tt_um_eric_lcc_47 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net47));
 sky130_fd_sc_hd__conb_1 tt_um_eric_lcc_48 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net48));
 sky130_fd_sc_hd__conb_1 tt_um_eric_lcc_49 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net49));
 sky130_fd_sc_hd__buf_2 wire7 (.A(_0331_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
